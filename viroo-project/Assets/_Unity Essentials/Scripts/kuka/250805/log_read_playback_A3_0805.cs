// ====================================================================
//  A3LogRotator.cs  –  نسخهٔ اصلاح‌شده بدون پرش و بدون تغییر Scale
...
public class A3LogRotator0805 : MonoBehaviour
{
    /*──────── تنظیمات ────────*/
    [Header("Log File")]
    ...
    private IEnumerator Tail()
    {
        ...
        while (true)
        {
            ...
            {
                targetAngleX = a3 * a_scale + b_offset;
                firstValue = true;
            }
