...
public class A1LogRotator : MonoBehaviour
{
    [Header("Log File")]
    ...
    private void Update()
    {
        ...
        float ny = Mathf.SmoothDampAngle(eul.y, targetAngleY, ref angleVelocity, smoothTime);
        transform.rotation = Quaternion.Euler(eul.x, ny, eul.z);
