...
public class A2LogRotator : MonoBehaviour
{
    [Header("Log File")]
    ...
    public float a_scale = 0.1f;          // مثلا °/10
    ...
    private static bool TryParseA2(string raw, out float a2)
    {
        ...
        return tok.Length > 1 &&
               float.TryParse(tok[1], NumberStyles.Float, CultureInfo.InvariantCulture, out a2);
    }
}
